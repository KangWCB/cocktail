...
public class QLikes extends EntityPathBase<Likes> {
    ...
    private static final long serialVersionUID = -473256963L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QLikes likes = new QLikes("likes");

    public final com.example.toycocktail.cocktail.model.QCocktail cocktail;
    ...
    public QLikes(Class<? extends Likes> type, PathMetadata metadata, PathInits inits) {
        ...
        this.cocktail = inits.isInitialized("cocktail") ? new com.example.toycocktail.cocktail.model.QCocktail(forProperty("cocktail"), inits.get("cocktail")) : null;
